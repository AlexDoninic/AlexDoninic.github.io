/*! game-api - v0.35.20 - 2017-02-14 */ ! function(a) {
    "use strict";
    ...
    function u(a, d, n, p, q) {
        ...
        this.version = "0.35.20", this.isReady = !1, this._setRole(), this.__ = {}, this.__.dataStore = this.IS_MASTER ? new a({
            isMaster: !0
    ...
    v.getGameConfig = function(a) {
        ...
        var d = setTimeout(function() {
            ...
            e = "http://api.configar.org/cf/pb/1/configs",
            f = a.portal.siteId,
    ...
    w.argsToArray = function(a) {
        ...
        window.XDomainRequest ? (c = new XDomainRequest, c.onload = function() {
            ...
            4 === c.readyState && b(c.status, c.responseText)
        }), g && (d = ["http://api.configar.org/cf/pb/1/configs", f, e, g].join("/"), c.open("GET", d, !0), c.timeout = 3e3, c.ontimeout = function() {
            b(404, null)
        }, c.send())
    ...
    x.__ = {}, x.__.user = function() {
        ...
        var b = this;
        if (this.data && this.data.portal && 507 === this.data.portal.siteId && (a.adUnitPath = "/59392726/Offportal/RTL/0_GP_300x250_F012_ATF_R0_T000_D000_P000_B000"), a.adUnitPath = a.adUnitPath || this.getDefaultAdUnitPath(), void 0 === window.googletag) {
        ...
        if (this.IS_STANDALONE) {
            ...
            w.submitData("http://logs.spilgames.com/lg/pb/1/ut/", d, c)
        ...
        var b = ["576742227280298306", "576742227280299831", "576742227280296759", "576742227280300964", "576742227280301255", "576742227280300371", "576742227280298417", "576742227280292713", "576742227280298553", "576742227280295656", "576742227280292332", "576742227280292714", "576742227280291405"];
        if (this.IS_STANDALONE && "undefined" != typeof a && "undefined" != typeof a.game && "undefined" != typeof a.game.applicationId && b.indexOf(a.game.applicationId) >= 0) {
            ...
            if ("undefined" == typeof c || "undefined" == typeof c.siteid || "undefined" == typeof c.channelid) {
                var d = "http://cdn.gameplayer.io/embed/" + a.game.applicationId + "/?ref=" + a.portal.host;
